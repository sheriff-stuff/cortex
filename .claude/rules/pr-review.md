...
All comments and replies posted by Claude on GitHub (PR comments, review replies, PR descriptions) must start with "🤖 beep boop — this is Claude, not a human." followed by the actual message. This makes it clear the response is AI-generated.
